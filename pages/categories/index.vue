...
const handleCreateCategory = async () => {
  const res = await categoryStore.addCategory(categoryFormData);
  ...
  if (res.errors) {
    ...
    useToastify("Category added successfully!", {
      autoClose: 3000,
...
<template>
  <div>
    <div
      ...
      <MainCategories :categories="categoryStore.parentCategories" />
